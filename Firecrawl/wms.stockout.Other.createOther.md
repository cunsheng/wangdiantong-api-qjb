...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19<br>20<br>21<br>22 | `[`<br>```{`<br>```"outer_no"``:``"QTC123K-041610221"``,`<br>```"warehouse_no"``:``"lz"``,`<br>```"remark"``:``"aa"``,`<br>```"prop1"``:``"aa"``,`<br>```"is_check"``:``true``,`<br>```"goods_list"``: [`<br>```{`<br>```"spec_no"``:``"lz11"``,`<br>```"num"``: 1,`<br>```"defect"``:``false``,`<br>```"remark"``:``"test"``,`<br>```"batch_no"``:``"124545-02-21"``,`<br>```"production_date"``:``"2019-09-04 18:57:13"``,`<br>```"expire_date"``:``"2019-09-04 18:57:13"``,`<br>```"is_enable_sn"``:1，`<br>```"sn_list"``:``"SN20250102001,SN20250102002"`<br>```}`<br>```]`<br>```}`<br>`]` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `{`<br>```"status"``: 0,`<br>```"data"``: {`<br>```"message"``:``"lj3284923423322"``,`<br>```"status"``: 0`<br>```}`<br>`}` |
