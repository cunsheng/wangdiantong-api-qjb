...
| 订单类型 | trade\_type | Int |  | 是 | 通过中间表关联到的退换单明细中后关联订单，关联不到的情况下值为：网店销售<br>2：线下订单<br>3：售后换货<br>4：批发业务<br>5：保修换新<br>6：保修完成<br>7：现款销售<br>8：分销<br>101~110：自定义1~10 |
...
|     |     |
| --- | --- |
|  | `[{`<br>`"start_time"``:``"2019-09-01 00:00:00"``,`<br>`"end_time"``:``"2019-10-01 23:59:59"`<br>`}]` |
