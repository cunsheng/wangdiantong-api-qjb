...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11 | `{`<br>```"status"``: 0,`<br>```"data"``: {`<br>```"logistics_name"``:``"自有物流"``,`<br>```"sys_logistics_name"``:``"自由物流"``,`<br>```"province"``: 120000,`<br>```"city"``: 120100,`<br>```"logistics_no"``:``"ZS202503310005"``,`<br>```"district"``: 120116,`<br>```"calc_weight"``: 10`<br>```}` |
