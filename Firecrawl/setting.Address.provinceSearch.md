---
url: "https://open.wangdian.cn/qjb/open/apidoc/doc?path=setting.Address.provinceSearch"
title: "API文档"
---
...
**setting.Address.provinceSearch（地址查询-省** **）**
...
| 名称 | 字段 | 类型 | 长度 | 必须 | 描述 |
| --- | --- | --- | --- | --- | --- |
| 国家id | country\_id | Int | 11 | Y | 国家id |
| 省id | province\_id | int |  | Y | 省id |
| 名称 | name | String |  | Y | 名称 |
...
| JSON | |     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8<br>9<br>10<br>11<br>12<br>13<br>14<br>15<br>16<br>17<br>18<br>19<br>20 | `{`<br>```"data"``: {`<br>```"detail_list"``: [`<br>```{`<br>```"country_id"``: 0,`<br>```"modified"``:``"2022-03-08 10:16:01"``,`<br>```"name"``:``"北京"``,`<br>```"province_id"``: 110000`<br>```},`<br>```{`<br>```"country_id"``: 0,`<br>```"modified"``:``"2022-03-08 10:16:01"``,`<br>```"name"``:``"天津"``,`<br>```"province_id"``: 120000`<br>```}`<br>```],`<br>```"total_count"``: 35`<br>```},`<br>```"status"``: 0`<br>`}` | |
