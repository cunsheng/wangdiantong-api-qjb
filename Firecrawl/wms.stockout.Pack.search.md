...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `[`<br>```{`<br>```"end_time"``:``"2020-06-02 11:26:31"``,`<br>```"start_time"``:``"2020-05-12 11:00:00"`<br>```}`<br>`]` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `{`<br>```"message"``:``"您的查询时间过宽,查询时间不能大于30天"``,`<br>```"status"``: 100`<br>`}` |
