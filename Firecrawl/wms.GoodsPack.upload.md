...
| json格式请求报文 | |     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7<br>8 | `[`<br>```{`<br>```"num"``: 1,`<br>```"src_spec_no"``:``"lzx0612-3"``,`<br>```"status"``: 0,`<br>```"warehouse_no"``:``"1001"`<br>```}`<br>`]` | |
| php 请求示例 | |     |     |
| --- | --- |
...
| json | |     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `{`<br>```"data"``:``"Z202406170016"``,`<br>```"status"``: 0`<br>`}` | |
...
| json | |     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `{`<br>```"message"``:``"状态错误"``,`<br>```"status"``: 100`<br>`}` | |
