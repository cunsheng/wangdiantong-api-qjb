...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6 | `[{`<br>```"status"``: 30,`<br>```"order_type"``: 21,`<br>```"start_time"``:``"2020-02-03 17:15:17"``,`<br>```"end_time"``:``"2020-02-03 17:55:17"`<br>`}]` |
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `{`<br>```"status"``: 100,`<br>```"message"``:``"参数中必须包含状态"`<br>`}` |
