---
url: "https://open.wangdian.cn/qjb/open/apidoc/doc?path=sales.RawTrade.pushSelf"
title: "API文档"
---
...
| **1.2 适用版本：** 客户端 V1.5.9.9及以上版本 |
| **1.3注意事项：** **【权限校验】：店铺权限（仅支持自有平台推送）**；上线之前必须在测试环境测试订单推送之后的相关流程!!!<br>**接口已过时, 请使用**[**sales.RawTrade.pushSelf2**](https://open.wangdian.cn/qjb/open/apidoc/doc?path=sales.RawTrade.pushSelf2) |
...
| 平台状态 | trade\_status | Int | 4 | 是 | 10未确认 20待尾款 30待发货 40部分发货 50已发货 60已签收 70已完成 80已退款 90已关闭(付款前取消)，单据状态变更点击文档查看 |
...
| 已支付金额 | paid | Decimal(19,4) |  | 否 | 已支付金额 |
...
- [JSON](https://open.wangdian.cn/qjb/open/apidoc/doc?path=sales.RawTrade.pushSelf#autoTab0_0)
- [PHP](https://open.wangdian.cn/qjb/open/apidoc/doc?path=sales.RawTrade.pushSelf#autoTab0_1)
- [JAVA](https://open.wangdian.cn/qjb/open/apidoc/doc?path=sales.RawTrade.pushSelf#autoTab0_2)
- [C#](https://open.wangdian.cn/qjb/open/apidoc/doc?path=sales.RawTrade.pushSelf#autoTab0_3)
...
|     |     |
| --- | --- |
| 1<br>2<br>3<br>4<br>5<br>6<br>7 | `{`<br>`"status"``: 0,`<br>`"data"``: {`<br>`"chg_count"``: 0,`<br>`"new_count"``: 1`<br>`}`<br>`}` |

6.2 异常响应示例

- [JSON](https://open.wangdian.cn/qjb/open/apidoc/doc?path=sales.RawTrade.pushSelf#autoTab1_0)

|     |     |
| --- | --- |
| 1<br>2<br>3<br>4 | `{`<br>`"status"``: 100,`<br>`"message"``:``"店铺编号不存在或已停用"`<br>`}` |
